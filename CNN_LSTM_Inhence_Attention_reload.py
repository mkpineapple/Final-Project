...
with tf.device('/device:GPU:0'):
    with tf.Session(config=tf.ConfigProto(log_device_placement=True, gpu_options=gpu_options,
        ...
        saver = tf.train.import_meta_graph('save_LSTM_CNN_Inhence_Attention_model/' +
                                           'cnn_lstm_attention_model_v1.ckpt.meta')
        saver.restore(sess, "save_LSTM_CNN_Inhence_Attention_model/cnn_lstm_attention_model_v1.ckpt")
